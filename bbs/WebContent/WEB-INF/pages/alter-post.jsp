...
<body class="whole" style="padding-left:20px">
	...
	<form action="postServlet?method=alterSuccess&postId=${post.postId }" method="post">
		<input type="hidden" name="postId" value=${post.postId }/>
		<table  cellspacing="0" cellpadding="10" border="1" bordercolor="#96CDCD" width="1300">
				<tr>
					<td>标题:</td>
					<td><input id="titleVal" type="text" name="title" value="${post.title }"/><font  id="titleMsg"></font>
					</td>
				</tr>
				<tr>
					<td>内容:</td>
					<td><textarea id="contentVal"  name="content"  rows="10" cols="170">${post.content }</textarea>
